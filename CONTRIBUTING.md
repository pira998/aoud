# Contributing to Claude Mobile Bridge

Thank you for your interest in contributing to Claude Mobile Bridge!
...
1. Fork and clone:
```bash
git clone https://github.com/YOUR_USERNAME/claude-mobile-bridge.git
...
2. Test CLI: `npx claude-bridge start`
