...
// Get server URL from localStorage or auto-detect from current host
const getServerUrl = (): string => {
  ...
  // Check localStorage for previously saved URL
  const saved = localStorage.getItem('bridge-server-url');
